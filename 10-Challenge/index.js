...
const writeToFile = (htmlArr) => {
    return new Promise(( resolve, reject ) => {
       ...
       fs.writeFile( `./dist/${outputFileName}.html`, htmlArr.join(""), function(err) {
                ...
                inquirer.prompt([
                    {
                        type: "input",
                        name: "officeNumber",
                        message: "Please enter the office number for your team's manager: ",
                    }
                ])
                .then(function(data) {
    ...
    inquirer.prompt([
        {
            type: "input",
            name: "teamName",
            message: "Welcome to the Team Profile Generator. Please enter a name for your team: ",
        }
    ])
    .then(function(data) {
        const teamName = data.teamName;
        teamMembers.push(teamName);
        console.log("Thank you. The team name is "+teamName+". Please continue by filling out information for your manager first.");
